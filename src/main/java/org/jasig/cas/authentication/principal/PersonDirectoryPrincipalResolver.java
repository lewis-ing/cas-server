...
import org.jasig.cas.authentication.constant.UserConstant;
    ...
    public final Principal resolve(final Credential credential) {
        ...
        if (personAttributes == null) {
            ...
            if(credential instanceof UsernamePasswordCredential){
        		...
        		Map<String, Object> users = upc.getAttributeMap();
        		for(Entry<String, Object> entry : users.entrySet()){
        			attributes.put(UserConstant.USERATTR, (List<Object>)entry.getValue());
        		}
        	}
        }
