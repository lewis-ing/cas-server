...
public class TicketResource extends ServerResource{
    ...
    public final void acceptRepresentation(final Representation entity)  {
        ...
        try {
            ...
            ticketGrantingTicketId =  grantServiceTicket(ticketGrantingTicketId);
            ...
            String streq = StringUtils.repeat("----", 40);
            LOGGER.info(this+"  "+streq);
    ...
    public String grantServiceTicket(String ticketGrantingTicketId) throws TicketException{
    	String serviceTicketId = this.centralAuthenticationService.grantServiceTicket(ticketGrantingTicketId,new SimpleWebApplicationServiceImpl(casUrl));
