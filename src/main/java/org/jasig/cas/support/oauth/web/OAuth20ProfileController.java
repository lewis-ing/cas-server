...
public final class OAuth20ProfileController extends AbstractController {
    ...
    protected ModelAndView handleRequestInternal(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final JsonGenerator jsonGenerator = jsonFactory.createGenerator(response.getWriter());
        ...
        try {
            ...
            final TicketGrantingTicket ticketGrantingTicket = (TicketGrantingTicket) this.ticketRegistry.getTicket(accessToken).getGrantingTicket();
